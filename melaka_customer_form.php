...
if(isset($_POST['submit'])){
    ...
    if($row > 0){
        ...
        header('location:melaka_customer_package.php');
    }else{
                ...
                <form method="POST">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            $fetch = $query->fetch_array();
                            ?>
                            <input type="number" name="state_id" value="2" hidden="">
                            ...
                            <div class="form-group">
                                <input style="text-transform: capitalize;" style="text-transform: capitalize;" name="customer_name" class="form-control mb-30" type="text" placeholder="Full Name" required="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <input style="background-color: #e7f2fd; border: #e7f2fd" class="form-control mb-30" placeholder="Melaka" disabled="">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input style="text-transform: capitalize;" style="text-transform: capitalize;" name="optional_place" type="text" class="form-control mb-60" placeholder="Optional Place">
                            </div>
                        </div>
                        <div class="col-lg-12">
