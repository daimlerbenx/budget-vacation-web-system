            ...
            <div class="classy-nav-container breakpoint-off">
                <nav class="classy-navbar justify-content-between" id="uzaNav">
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                <li class="current-item"><a href="kuala_lumpur.php">Kuala Lumpur</a></li>
                ...
                <div class="breadcumb--con">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Kuala Lumpur</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<section class="uza-portfolio-area section-padding-80">
    ...
    <div class="container-fluid">
        <div class="row uza-portfolio">
            ...
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'place' AND `state_id` = 1 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item place">
                    <div class="single-portfolio-slide">
                        <img src="photo/kl/<?php echo $fetch['place_photo']?>">
            ...
            <?php
            require_once 'admin/database_connection.php';
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'breakfast' AND `state_id` = 1 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
            ...
            <?php
            require_once 'admin/database_connection.php';
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'lunch' AND `state_id` = 1 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
        ...
        ?>
            ...
            <?php
            require_once 'admin/database_connection.php';
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'dinner' AND `state_id` = 1 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
