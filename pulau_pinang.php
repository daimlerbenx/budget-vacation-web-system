...
<body>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                ...
                                <li class="current-item"><a href="pulau_pinang.php">Pulau Pinang</a></li>
                                </li>
                            </ul>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcumb--con">
                        <h2 class="title">Pulau Pinang</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Pulau Pinang</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="uza-portfolio-area section-padding-80">
        ...
        <div class="container-fluid">
            ...
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'place' AND `state_id` = 3 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3 single-portfolio-item place">
                    <div class="single-portfolio-slide">
                        <img src="photo/pp/<?php echo $fetch['place_photo']?>">
            ...
            ?>
                ...
                <?php
            require_once 'admin/database_connection.php';
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'breakfast' AND `state_id` = 3 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
            ...
            ?>
                ...
                <?php
            require_once 'admin/database_connection.php';
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'lunch' AND `state_id` = 3 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
        ...
        ?>
                ...
                <?php
            require_once 'admin/database_connection.php';
            $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'dinner' AND `state_id` = 3 ORDER BY `place_id` ASC ") or die(mysql_error());
            while($fetch = $query->fetch_array()){
                ?>
