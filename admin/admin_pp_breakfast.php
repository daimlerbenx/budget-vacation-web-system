                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <a  style="background-color: transparent; color: #000; border-bottom: 2px solid #7ed6a5" class="btn btn-success" href="admin_pulau_pinang.php"><i></i>Place </a>
                        ...
                        <div class="card-header">
                           <a class="btn btn-success" href="add_pp_breakfast.php"><i class="glyphicon glyphicon-edit"></i>Add Breakfast</a>
                        </div>
                        <div class="card-body">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'breakfast' AND `state_id` = 3") or die(mysqli_error());
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-right">
                                        <a class="btn btn-warning" href="update_pp_breakfast.php?place_id=<?php echo $fetch['place_id']?>">Update </a> 
                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_pp_breakfast.php?place_id=<?php echo $fetch['place_id']?>">Delete </a></td>
                                    </tr>
                                    <?php
                                       }
                                       ?>
