...
<body class="">
  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="active "><a style="cursor: default;"><i class="nc-icon nc-image"></i><p>State</p></a></li>
          <li><a href="admin_place.php"><i class="nc-icon nc-map-big"></i><p>Place</p></a></li>
    ...
    <div class="main-panel">
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">State</a>
          </div>
      ...
      <div class="content">
        <a class="btn btn-success" href="admin_add_state.php">ADD STATE </a>
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <i class="fa"></i> <a style="text-decoration: none; font-weight: 700; cursor: default;">Kuala Lumpur</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <i class="fa"></i> <a style="text-decoration: none; font-weight: 700; cursor: default;">Melaka</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <i class="fa"></i> <a style="text-decoration: none; font-weight: 700; cursor: default;">Pulau Pinang</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <?php
            ...
            $query = $conn->query("SELECT * FROM `state` WHERE state_id > 3") or die(mysql_error());
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  <div class="col-5 col-md-4">
                    <div class="icon-big text-center icon-warning">
                      <img style="border-radius: 50%" src="state/<?php echo $fetch['state_photo']?>">
                    </div>
                  </div>
                  <div class="col-7 col-md-8">
                    <a style="float: right;" href="process_delete_state.php?state_id=<?php echo $fetch['state_id']?>"><i class="nc-icon nc-simple-remove text-danger"></i></a><br>
                    <div class="numbers">
                      <p class="card-category"> Total Place</p>
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <i class="fa"></i> <a style="text-decoration: none; font-weight: 700; cursor: default; text-transform: capitalize;"><?php echo $fetch['state_name'] ?></a>
                </div>
              </div>
            </div>
          </div>
