      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#" style="cursor: default;">State | Place - Melaka</a>
          </div>
                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <a  style="background-color: transparent; color: #000; border-bottom: 2px solid #7ed6a5" class="btn btn-success" href="admin_melaka.php"><i></i>Place </a>
                           <a style="background-color: #28a745;" class="btn btn-success" href="#"><i></i>Breakfast </a>
                           <a style="background-color: transparent; color: #000; border-bottom: 2px solid #7ed6a5" class="btn btn-success" href="admin_melaka_lunch.php"><i></i>Lunch </a>
                           <a style="background-color: transparent; color: #000; border-bottom: 2px solid #7ed6a5" class="btn btn-success" href="admin_melaka_dinner.php"><i></i>Dinner </a>
                        </div>
                        <div class="card-header">
                           <a class="btn btn-success" href="add_melaka_breakfast.php"><i class="glyphicon glyphicon-edit"></i>Add Breakfast</a>
                        </div>
                        <div class="card-body">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'breakfast' AND `state_id` = 2") or die(mysqli_error());
                                       while($fetch = $query->fetch_array()){
                                        ?>
                                    <tr>
                                       <td><img src="../photo/melaka/<?php echo $fetch['place_photo']?>" height = "60" width = "80"></td>
                                       <td><?php echo $fetch['place_name']?></td>
                                       <td><?php echo $fetch['place_day']?></td>
                                       <td class="text-right">
                                        <a class="btn btn-warning" href="update_melaka_breakfast.php?place_id=<?php echo $fetch['place_id']?>">Update </a> 
                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_melaka_breakfast.php?place_id=<?php echo $fetch['place_id']?>">Delete </a></td>
                                    </tr>
                                    <?php
                                       }
                                       ?>
