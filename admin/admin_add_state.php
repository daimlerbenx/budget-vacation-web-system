...
if(ISSET($_POST['add_state'])){
  ...
  $state_photo = addslashes(file_get_contents($_FILES['state_photo']['tmp_name']));
  $photo_name = addslashes($_FILES['state_photo']['name']);
  $photo_size = getimagesize($_FILES['state_photo']['tmp_name']);
  move_uploaded_file($_FILES['state_photo']['tmp_name'],"state/" . $_FILES['state_photo']['name']);
  $conn->query("INSERT INTO `state` (state_name, state_photo) VALUES('$state_name', '$photo_name')") or die(mysqli_error());
    ...
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="active ">
            <a style="cursor: default;"><i class="nc-icon nc-image"></i><p>State</p></a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#" style="cursor: default;">State</a>
          </div>
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Add State</h5>
            <form method = "POST" enctype = "multipart/form-data">
              <div class="row">
               <div class="col-md-4 pr-1">
                <div class="form-group">
                 <label>State Name</label>
                 <input style="text-transform: capitalize;" name="state_name" type="text" class="form-control" required="">
               </div>
             </div>
           </div>
           <div class="col-md-4 pl-1">
             ...
             <input class="form-control" type="file" required="required" id="photo" name="state_photo">
           </div>
         </div>
         <div class="row">
           <div class="col-md-12">
            <a class="btn btn-danger" href="admin_state.php">Cancel </a>
            <button name="add_state" class="btn btn-success">Add State </button>
          </div>
        </div>
      </form>
    </div>
