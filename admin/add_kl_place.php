  ...
  <div class="wrapper ">
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Add Place - Kuala Lumpur</h5>
            <form method = "POST" enctype = "multipart/form-data">
              <input name="place_type" type="text" value="place" hidden="">
   ...
   <div class="row">
     <div class="col-md-12">
      ...
      <button name="add_place" class="btn btn-success">Add Place </button>
    </div>
  </div>
</form>
</div>
