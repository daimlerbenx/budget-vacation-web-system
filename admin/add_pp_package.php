...
if(ISSET($_POST['add_package'])){
    ...
    $conn->query("INSERT INTO `package` (package_name, package_price, state_id) VALUES('$package_name', '$package_price', '$state_id')") or die(mysqli_error());
    header("location:admin_package_pp.php");
}
?>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#" style="cursor: default;">Package - Pulau Pinang</a>
          </div>
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Add Package - Pulau Pinang</h5>
            <form method = "POST">
              <input name="state_id" type="number" value="3" hidden="">
              <div class="row">
               <div class="col-md-4 pr-1">
                <div class="form-group">
                 <label>Package Name</label>
                 <input name="package_name" type="text" class="form-control" required="">
               </div>
             </div>
           </div>
           <div class="row">
             <div class="col-md-4 pr-1">
              <div class="form-group">
               ...
               <input name="package_price" maxlength="4" min="10" max="1001" type="number" class="form-control" required="">
            </div>
          </div>
        </div>
   <div class="row">
     <div class="col-md-12">
      <a class="btn btn-danger" href="admin_package_pp.php">Cancel </a>
