...
if(ISSET($_POST['update_tax'])){
    $tax = $_POST['tax'];
    mysqli_query($conn, "UPDATE `tax` SET `tax` = '$tax' WHERE `tax_id` = '1'") or die(mysqli_error());
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Dashboard - Update Tax</a>
          </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <?php
                  $q_p = $conn->query("SELECT COUNT(*) as total FROM `feedback`") or die(mysqli_error());
                  $f_p = $q_p->fetch_array();
                  ?>
                  <div class="col-7 col-md-8">
                    <div class="numbers">
              ...
              <div class="row">
               <div class="col-md-4 pr-1">
                <div class="form-group">
                 <label>Tax %</label>
                 <input name="tax" type="number" min="1" max="100" class="form-control" required="" value="<?php echo $fetch['tax']?>">
               </div>
             </div>
           </div>
   <div class="row">
     <div class="col-md-12">
      ...
      <button name="update_tax" class="btn btn-success">Update Tax </button>
    </div>
  </div>
</form>
              </div>
