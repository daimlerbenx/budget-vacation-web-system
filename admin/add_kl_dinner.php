...
if(ISSET($_POST['add_dinner'])){
  ...
  header("location:admin_kuala_lumpur_dinner.php");
}
?>
...
<body class="">
  ...
  <div class="wrapper ">
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Add Dinner - Kuala Lumpur</h5>
            <form method = "POST" enctype = "multipart/form-data">
              <input name="place_type" type="text" value="dinner" hidden="">
              <input name="place_time" type="text" value="1830_2030" hidden="">
   ...
   <div class="row">
     <div class="col-md-12">
      <a class="btn btn-danger" href="admin_kuala_lumpur_dinner.php">Cancel </a>
      <button name="add_dinner" class="btn btn-success">Add Dinner </button>
    </div>
  </div>
</form>
</div>
