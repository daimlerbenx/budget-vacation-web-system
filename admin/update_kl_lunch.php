...
if(ISSET($_POST['update_lunch'])){
    ...
    header("location:admin_kuala_lumpur_lunch.php");
  }
?>
...
<body class="">
  ...
  <div class="wrapper ">
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Update Lunch - Kuala Lumpur</h5>
            <?php
                              include "database_connection.php";
   ...
   <div class="row">
     <div class="col-md-12">
      <a class="btn btn-danger" href="admin_kuala_lumpur_lunch.php">Cancel </a>
      <button name="update_lunch" class="btn btn-success">Update Lunch </button>
    </div>
  </div>
</form>
</div>
