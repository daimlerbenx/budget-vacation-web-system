    ...
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          </li><li><a href="admin_place"><i class="nc-icon nc-map-big"></i><p>Place</p></a></li>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#" style="cursor: default;">Package</a>
          </div>
                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <a style="background-color: transparent; color: #000; border-bottom: 2px solid #7ed6a5" class="btn btn-success" href="admin_package.php"><i></i>Kuala Lumpur </a>
                           <a style="background-color: transparent; color: #000; border-bottom: 2px solid #7ed6a5" class="btn btn-success" href="admin_package_melaka.php"><i></i>Melaka </a>
                           <a style="background-color: #28a745" class="btn btn-success" href="#"><i></i>Pulau Pinang </a>
                        </div>
                        <div class="card-header">
                           <a class="btn btn-success" href="add_pp_package.php"><i class="glyphicon glyphicon-edit"></i>Add Package</a>
                        </div>
                        <div class="card-body">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $query = $conn->query("SELECT * FROM `package` WHERE state_id = 3") or die(mysqli_error());
                                       while($fetch = $query->fetch_array()){
                                        ?>
                                    <tr>
                                       <td><?php echo $fetch['package_name']?></td>
                                       <td>RM <?php echo $fetch['package_price']?></td>
                                       <td class="text-right">
                                        <a class="btn btn-warning" href="update_pp_package.php?package_id=<?php echo $fetch['package_id']?>">Update </a> 
                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_pp_package.php?package_id=<?php echo $fetch['package_id']?>">Delete </a></td>
                                    </tr>
                                    <?php
                                       }
                                       ?>
