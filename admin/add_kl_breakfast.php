  ...
  <div class="wrapper ">
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Add Breakfast - Kuala Lumpur</h5>
            <form method = "POST" enctype = "multipart/form-data">
              <input name="place_type" type="text" value="breakfast" hidden="">
              <input name="place_time" type="text" value="0800_0900" hidden="">
              <input name="state_id" type="number" value="1" hidden="">
              <div class="row">
   ...
   <div class="row">
     <div class="col-md-12">
      ...
      <button name="add_breakfast" class="btn btn-success">Add Breakfast </button>
    </div>
  </div>
</form>
</div>
