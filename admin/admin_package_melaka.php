                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           ...
                           <a style="background-color: #28a745;" class="btn btn-success" href="#"><i></i>Melaka </a>
                           <a style="background-color: transparent; color: #000; border-bottom: 2px solid #7ed6a5" class="btn btn-success" href="admin_package_pp.php"><i></i>Pulau Pinang </a>
                        </div>
                        <div class="card-header">
                           <a class="btn btn-success" href="add_melaka_package.php"><i class="glyphicon glyphicon-edit"></i>Add Package</a>
                        </div>
                        <div class="card-body">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $query = $conn->query("SELECT * FROM `package` WHERE state_id = 2") or die(mysqli_error());
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-right">
                                        <a class="btn btn-warning" href="update_melaka_package.php?package_id=<?php echo $fetch['package_id']?>">Update </a> 
                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_melaka_package.php?package_id=<?php echo $fetch['package_id']?>">Delete </a></td>
                                    </tr>
                                    <?php
                                       }
                                       ?>
