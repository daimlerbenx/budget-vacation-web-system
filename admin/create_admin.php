...
if(ISSET($_POST['create'])){
  ...
  $admin_photo = addslashes(file_get_contents($_FILES['admin_photo']['tmp_name']));
  $photo_name = addslashes($_FILES['admin_photo']['name']);
  $photo_size = getimagesize($_FILES['admin_photo']['tmp_name']);
  move_uploaded_file($_FILES['admin_photo']['tmp_name'],"photo/" . $_FILES['admin_photo']['name']);
  $conn->query("INSERT INTO `admin` (admin_name, admin_username, admin_password, admin_photo) VALUES('$admin_name', '$admin_username', '$admin_password', '$photo_name')") or die(mysqli_error());
  echo '<script type="text/javascript"> alert("Admin created successful"); location="dashboard.php"; </script>';
}
?>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Dashboard - Create Admin</a>
          </div>
            ...
            <ul class="navbar-nav">
              <li class="nav-item btn-rotate dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" style="cursor: default;">Create Admin</a>
                   ...
                   <div class="col-md-4 pr-1">
                    <div class="form-group">
                      ...
                      <div class="col-md-4 pl-1">
                       ...
                       <input class="form-control" type="file" required="required" id="photo" name="admin_photo">
                     </div>
                   </div>
                 </div>
               </div>
