    ...
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="active "><a href="#"><i class="nc-icon nc-tile-56"></i><p>Feedback</p></a></li>
        </ul>
      </div>
    </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      while($fetch = $query->fetch_array()){
                        ?>
                        <tr>
                         <td style="text-transform: capitalize;"><?php echo $fetch['feedback_name']?></td>
                         <td><?php echo $fetch['feedback_email']?></td>
                         <td><?php echo $fetch['feedback_phone']?></td>
                         <td><?php echo $fetch['feedback_country']?></td>
                         <td class="text-right">
                          <a class="btn btn-success" href="view_feedback.php?feedback_id=<?php echo $fetch['feedback_id']?>"> View</a> 
                          <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_feedback.php?feedback_id=<?php echo $fetch['feedback_id']?>"> Delete</a>
                        </td>
                      </tr>
                      <?php
                    }
