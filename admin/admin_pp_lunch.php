               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        ...
                        <div class="card-header">
                           <a class="btn btn-success" href="add_pp_lunch.php"><i class="glyphicon glyphicon-edit"></i>Add Lunch</a>
                        </div>
                        <div class="card-body">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'lunch' AND `state_id` = 3") or die(mysqli_error());
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-right">
                                        <a class="btn btn-warning" href="update_pp_lunch.php?place_id=<?php echo $fetch['place_id']?>">Update </a> 
                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_pp_lunch.php?place_id=<?php echo $fetch['place_id']?>">Delete </a></td>
                                    </tr>
                                    <?php
                                       }
                                       ?>
