                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <a style="background-color: #28a745;" class="btn btn-success" href="#"><i></i>Kuala Lumpur </a>
                        ...
                        <div class="card-header">
                           <a class="btn btn-success" href="add_kl_package.php"><i class="glyphicon glyphicon-edit"></i>Add Package</a>
                        </div>
                        <div class="card-body">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $query = $conn->query("SELECT * FROM `package` WHERE state_id = 1") or die(mysqli_error());
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-right">
                                        <a class="btn btn-warning" href="update_kl_package.php?package_id=<?php echo $fetch['package_id']?>">Update </a> 
                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_kl_package.php?package_id=<?php echo $fetch['package_id']?>">Delete </a></td>
                                    </tr>
                                    <?php
                                       }
                                       ?>
