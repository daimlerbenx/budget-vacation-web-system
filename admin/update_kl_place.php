...
if(ISSET($_POST['update_place'])){
    ...
    move_uploaded_file($_FILES['place_photo']['tmp_name'],"../photo/kl/" . $_FILES['place_photo']['name']);
    mysqli_query($conn, "UPDATE `place` SET `place_name` = '$place_name', `place_desc` = '$place_desc', `place_time` = '$place_time', `place_day` = '$place_day', `place_photo` = '$photo_name' WHERE `place_id` = '$_REQUEST[place_id]'") or die(mysqli_error());
    header("location:admin_kuala_lumpur.php");
  }
?>
...
<body class="">
  ...
  <div class="wrapper ">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#" style="cursor: default;">State | Place - Kuala Lumpur</a>
          </div>
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Update Place - Kuala Lumpur</h5>
            <?php
                              include "database_connection.php";
           ...
           <?php
           $time = array("0930_1130", "1330_1530", "1600_1800", "2100_2200");
           ?>
           <div class="row">
             <div class="col-md-4 pr-1">
              <div class="form-group">
               <label>Place Time</label>
               <select class="form-control mb-30 unstyled" name="place_time" required="">
                <option hidden="" value="<?php echo $fetch['place_time']?>"><?php echo $fetch['place_time']?></option>
                <?php
     ...
     <div class="col-md-4 pl-1">
       <div class="form-group">
        ...
        <div id = "preview" style = "width:150px;">
         <img src = "../photo/kl/<?php echo $fetch['place_photo']?>" id = "lbl" width = "100%" height = "100%"/>
       </div>
   ...
   <div class="row">
     <div class="col-md-12">
      <a class="btn btn-danger" href="admin_kuala_lumpur.php">Cancel </a>
      <button name="update_place" class="btn btn-success">Update Place </button>
    </div>
  </div>
</form>
</div>
