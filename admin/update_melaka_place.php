...
<body class="">
  ...
  <div class="wrapper ">
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Update Place - Melaka</h5>
            <?php
                              include "database_connection.php";
     ...
     <div class="col-md-4 pl-1">
       <div class="form-group">
        ...
        <div id = "preview" style = "width:150px;">
         <img src = "../photo/melaka/<?php echo $fetch['place_photo']?>" id = "lbl" width = "100%" height = "100%"/>
       </div>
   ...
   <div class="row">
     <div class="col-md-12">
      <a class="btn btn-danger" href="admin_melaka.php">Cancel </a>
