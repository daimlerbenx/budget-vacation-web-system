...
if(ISSET($_POST['update_breakfast'])){
    ...
    header("location:admin_melaka_breakfast.php");
  }
?>
...
<body class="">
  ...
  <div class="wrapper ">
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Update Breakfast - Melaka</h5>
            <?php
                              include "database_connection.php";
   ...
   <div class="row">
     <div class="col-md-12">
      <a class="btn btn-danger" href="admin_melaka_breakfast.php">Cancel </a>
