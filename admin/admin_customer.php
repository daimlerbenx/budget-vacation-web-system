                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $query = $conn->query("SELECT * FROM `customer` NATURAL JOIN `state` NATURAL JOIN `package` ORDER BY customer_id DESC") or die(mysqli_error());
                                                    while($fetch = $query->fetch_array()){
                                                     ?>
                                                <tr>
                                                    <td style="text-transform: capitalize;"><?php echo $fetch['customer_name']?></td>
                                                    <td><?php echo $fetch['customer_phone']?></td>
                                                    <td><?php echo $fetch['package_name']?> | RM<?php echo $fetch['package_price']?></td>
                                                    <td><?php echo $fetch['date_book']?></td>
                                                    <td>RM <?php echo $fetch['budget']?></td>
                                                    <td>RM<?php echo $fetch['bill']?></td>
                                                    <td class="text-right">
                                                        <a class="btn btn-success" href="admin_print.php?customer_id=<?php echo $fetch['customer_id']?>"> Print</a> 
                                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_customer.php?customer_id=<?php echo $fetch['customer_id']?>"> Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                    }
