...
if(ISSET($_POST['update_breakfast'])){
    ...
    header("location:admin_kuala_lumpur_breakfast.php");
  }
?>
...
<body class="">
  ...
  <div class="wrapper ">
      ...
      <div class="content">
       <div class="row">
        <div class="col-md-12">
         <div class="card">
          <div class="card-body">
            <h5 class="text-info">Update Breakfast - Kuala Lumpur</h5>
            <?php
                              include "database_connection.php";
   ...
   <div class="row">
     <div class="col-md-12">
      <a class="btn btn-danger" href="admin_kuala_lumpur_breakfast.php">Cancel </a>
      <button name="update_breakfast" class="btn btn-success">Update Breakfast </button>
    </div>
  </div>
</form>
</div>
