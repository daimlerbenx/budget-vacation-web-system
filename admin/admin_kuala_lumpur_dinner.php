               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        ...
                        <div class="card-header">
                           <a class="btn btn-success" href="add_kl_dinner.php"><i class="glyphicon glyphicon-edit"></i>Add Dinner</a>
                        </div>
                        <div class="card-body">
                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php
                                       ...
                                       $query = $conn->query("SELECT * FROM `place` WHERE `place_type` = 'dinner' AND `state_id` = 1") or die(mysqli_error());
                                    ...
                                    <tr>
                                       ...
                                       <td class="text-right">
                                        <a class="btn btn-warning" href="update_kl_dinner.php?place_id=<?php echo $fetch['place_id']?>">Update </a> 
                                        <a class="btn btn-danger" onclick="confirmationDelete(this); return false;" href="process_delete_kl_dinner.php?place_id=<?php echo $fetch['place_id']?>">Delete </a></td>
                                    </tr>
                                    <?php
                                       }
                                       ?>
