...
if(ISSET($_POST['proceed'])){
    ...
    header("location:pp_customer_planner.php");
  }
?>
            ...
            <div style="margin-top: 30px" class="uza-contact-form mb-10">
                <form method="POST">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <select class="form-control mb-30 unstyled" name="package_price" required="">
                                    ...
                                    $query = $conn->query("SELECT * FROM `package` WHERE state_id = 3 AND package_price <= '$_SESSION[budget]'") or die(mysql_error());
                    ...
                    <div class="text-center">
                        ...
                        ?>
                        <a class="txt2" style="color: #1382f7" href="process_delete_pp_customer.php?customer_id=<?php echo $fetch['customer_id'] ?>">Previous</a>
                    </div>
                </form>
            </div>
        </div>
