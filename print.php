...
<body>
   ...
   <div style="margin-right: auto; margin-left: auto; width: 80%" class="wrap-login100-2">
      ...
      <h3>Departure from <font style="text-transform: capitalize; font-weight: 600; color: blue; float: right"><?php echo $fetch['state_to']; ?></font> 
         ...
         $fetch = $query->fetch_array();
         ?>
         <h6 style="color: gray">Service Tax <font style="color: #303030; font-weight: 600; float: right; color: gray"> <?php echo $fetch['tax_current']; ?> %</font></h6>
         <h3>Package Price<font style="color: red; font-weight: 600; float: right;">RM <?php echo $fetch['package_price']; ?>.00</font></h3>
         <h3>Total Paid<font style="color: red; font-weight: 600; float: right;">RM <?php echo $fetch['bill']; ?>.00</font></h3>
      </div>
      <aside><br><br>
